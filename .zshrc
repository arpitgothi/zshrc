...
export ZSH="/Users/agothi/.oh-my-zsh"
...
cg() { cloudctl stacks get $1 -o json > $1.json;code $1.json; }
...
sb() { ~/cloud/tools/splunkbase_info.sh -a $1 }
ac() { ~/cloud/tools/appStanza.sh -f $1 -s $2 -t $3;}
aa() { ~/cloud/tools/appStanza.sh -a $1;}
...
echo "|##  1] dif --> cloudctl stacks diff                               ##|";
echo "|##  1] prm --> Approve PR                                         ##|";
echo "|##  1] prc --> cancel PR                                          ##|";
echo "|##  1] prr --> Reject PR                                          ##|";
echo "|##  2] vl  --> vault login                                        ##|";
echo "|##  3] va  --> vault password get                                 ##|";
echo "|##  4] vp  --> vault password get with version                    ##|";
echo "|##  5] cg  --> cloudctl stacks get                                ##|";
echo "|##  6] cu  --> cloudctl stacks update                             ##|";
echo "|##  7] ps  --> app_pre_checks.py                                  ##|";
echo "|##  9] pc  --> custom app precheck                                ##|";
echo "|## 10] id  --> Add id_rsa                                         ##|";
echo "|## 11] pr  --> Add Routes by python script                        ##|";
echo "|## 12] nl  --> nslookup ( nl - *.splunkcloud.com )                ##|";
echo "|## 13] ns  --> nslookup ( for specific node.stack )               ##|";
echo "|## 14] sf  --> ssh (Use 'sf' for your user, 'ss' for splunk user) ##|";
echo "|## 15] jn  --> get Jenkin Build                                   ##|";
echo "|## 16] sb  --> splunkbase info                                    ##|";
echo "|## 17] ac  --> appStanza custom app                               ##|";
echo "|## 18] aa  --> appStanza standard app                             ##|";
echo "|## 19] cc  --> check ._ in etc                                    ##|";
echo "|## 20] pass -> stack-creads ( pass sh1 stack_name, SHC is N/A )   ##|";
echo "|####################################################################|"; 
echo " ";
}
